...
let markers = [
    ...
    },
    {
        time: 6,
        text:
            "lrem lrem v lremlremlremlremlrem lrem lrem lrem lrem lrem lrem lrem lrem lrem lrem lrem lremlremlrem lrem "
    },
    {
        time: 23.6,
        text: "Chapter 3"
...
const Player = props => {
    ...
    return (
        ...
        <video
            id={playerId}
            onDoubleClick={addMarkerInVideo}
            className={`video-js ${
